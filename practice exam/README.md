...
6. The votes are in! We have an array of the top dogs in each class (dogsdata.js)
    Using recursion, copy all of the properties into one object and return that object. If you'd like an idea of our data structure, look in the dogData.js file. From an array with three objects into one object
